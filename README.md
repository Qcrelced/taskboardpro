...
La méthode inject permet d'afficher un composant snas passer par le constructeur du composant permettant de faire des composants plus dynamiques avec la méthode viewContainerRef
